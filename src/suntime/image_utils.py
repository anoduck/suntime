...
# --------------------------------------
# The below class was shamelessly copied from github.com/H0lz3r-x64/OpenCV-Python-Utilities
# It is not our code, and we take no credit for it.
# -------------------------------------------------------
import numpy as np
import cv2
        ...
        if rowsAvailable:
            for x in range(0, rows):
                for y in range(0, cols):
                    imgArray[x][y] = cv2.resize(
                        imgArray[x][y], (int(sizeW * scale), int(sizeH * scale))
                    )
            ...
            for x in range(0, rows):
                imgArray[x] = cv2.resize(
                    imgArray[x], (int(sizeW * scale), int(sizeH * scale))
                )
